...
describe("Teacher.teach", function(){
    it("It prints the string 'guy is now teaching WAP' when invoked by teacher named 'guy' and passed 'WAP' as argument", function(){
        let guy = new Teacher("guy", 432);
        assert.equal("guy is now teaching WAP", guy.teach("WAP"));
    })
})
